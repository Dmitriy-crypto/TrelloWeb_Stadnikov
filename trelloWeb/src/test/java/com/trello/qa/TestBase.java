...
//    public static String password = "12345.com";
    ...
    boolean privet_team = false;//option selection not work
    ...
    //'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    int numberBoards = 20;// number of boards to creat
...
//        typeTextInTheField(By.cssSelector("[type=password]"), password);
    ...
    public void returnHome() throws InterruptedException {
        ...
        //span[@name='house']
        Thread.sleep(2000);
        clickOnWebElement(By.xpath("//a[@href='/']"));//click on a button Home
        Thread.sleep(1000);
        clickOnWebElement(By.xpath("//a[@href='/']"));//click on a button Home
        Thread.sleep(1000);
